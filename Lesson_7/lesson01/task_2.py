...
def print_directory_contents(sPath):
    ...
    for item in os.listdir(sPath):
        ...
        if os.path.isfile(full_name):
            print(f'{os.path.abspath(sPath)}/{item}')
        else:
...
# /home/minkika/Learning/interview_preparation/.git/objects/aa/5b4faa7100de9c463dae168d860cd2090ef731
...
# /home/minkika/Learning/interview_preparation/.git/objects/d5/db3410ed65d455ee7b2f860ccb3cf458b9c254
...
# /home/minkika/Learning/interview_preparation/.git/objects/a1/25f9505321084194736497a2cee41d73be099e
...
# /home/minkika/Learning/interview_preparation/.git/objects/86/282e24d3adfadf2625d1a2ed7485cb8f2ef1fb
